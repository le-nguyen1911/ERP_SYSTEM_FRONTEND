...
/**
 * Reusable modal for actions that require a reason (Reject / Cancel).
 */
export function SalesOrderActionModal({ isOpen, onClose, onConfirm, title, description, confirmLabel, confirmColor = '#dc2626', isLoading = false }) {
      ...
      <div style={{ position: 'relative', background: '#fff', borderRadius: 16, padding: 32, width: '100%', maxWidth: 480, boxShadow: '0 25px 50px rgba(0,0,0,0.25)' }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            rows={3}
            style={{
              width: '100%', padding: '10px 12px', border: `1px solid ${error ? '#dc2626' : '#e2e8f0'}`,
              borderRadius: 8, fontSize: 14, resize: 'vertical', fontFamily: 'inherit',
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            style={{
              ...
              background: confirmColor, color: '#fff', fontWeight: 600, fontSize: 14,
